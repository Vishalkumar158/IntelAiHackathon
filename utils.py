...
def project_bboxes(bboxes, width_scale_factor, height_scale_factor, mode='a2p'):
    ...
    # Convert width_scale_factor and height_scale_factor to Float type
    width_scale_factor = width_scale_factor.float()
    height_scale_factor = height_scale_factor.float()
...
def get_req_anchors(anc_boxes_all, gt_bboxes_all, gt_classes_all, pos_thresh=0.7, neg_thresh=0.2):
    ...
    gt_classes_all - torch.Tensor , max_oof shape (Bbjects)
