...
#         self.classifier = ClassificationModule(out_channels, n_classes, roi_size)
#
#     def forward(self, images, gt_bboxes=None, gt_classes=None):
...
#             return total_loss
#         else:
#             # During inference, return only proposals without computing losses
#             _, feature_map, proposals, _, _ = self.rpn(images)
#             return proposals
